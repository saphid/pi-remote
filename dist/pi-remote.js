...
function projectSessionsByProject(root) {
...
function listSavedSessionsForFilter(filter, limit) {
    const sessions = [];
...
function savedSessionsByProject(root, filter, limit, projects = new Set(listProjects(root))) {
